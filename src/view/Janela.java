...
public class Janela extends JFrame implements ActionListener {
    ...
    public Janela() {
        ...
        this.btnCorrida = new JButton("LARGADA");
        this.btnCancel = new JButton("SAIR");
                  // POSIONADO OS BOTÕES
        ...
        jPanel.setBorder(BorderFactory.createTitledBorder("[MARIO KART]"));
    ...
    public void actionPerformed(ActionEvent dispara) {
        if (dispara.getSource() == this.btnCorrida) {
            this.lblPista.add(JLabelCarros("Mario", imgCarro1, 0, 50));
            this.lblPista.add(JLabelCarros("Luigi", imgCarro2, 0, 200));
            this.lblPista.add(JLabelCarros("Peach", imgCarro3, 0, 350));
        }
